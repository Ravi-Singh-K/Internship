    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='college', to=settings.AUTH_USER_MODEL)),
            ],
            bases=('cvapp.basemodel',),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='language',
            field=models.ManyToManyField(to='cvapp.language'),
        ),
        migrations.CreateModel(
            name='PersonalInfo',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='personalinfo', to=settings.AUTH_USER_MODEL)),
            ],
            bases=('cvapp.basemodel',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enroll_date', models.DateField(blank=True)),
                ('passed_date', models.DateField(blank=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='school', to=settings.AUTH_USER_MODEL)),
            ],
            bases=('cvapp.basemodel',),
        ),
        migrations.AddField(
            model_name='customuser',
            name='skill',
            field=models.ManyToManyField(to='cvapp.skill'),
        ),
    ]
